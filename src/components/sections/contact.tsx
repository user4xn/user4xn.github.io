...
let email = 'wildan.desperado@gmail.com';
let phone = '+62 85939438777';
    ...
    <Container id="contact">
      <div className="flex flex-col items-center gap-4">
        ...
        <Typography variant="subtitle" className="max-w-xl text-center">
          What happens next? Please contact me if you need a developer, have a question, or just want to connect.
        </Typography>
      </div>
      ...
      <div className="flex flex-col items-center gap-6 md:gap-12">
        ...
        <div className="flex flex-col items-center gap-2">
          <Typography className="text-center">
            You also can catch up me on platforms below
          </Typography>
          <SocialIcons />
        </div>
      </div>
